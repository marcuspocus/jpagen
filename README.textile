...
* @jpagen.template.entity@ (default=db/entity.tmpl)
* @jpagen.template.idClass@ (default=db/idClass.tmpl)
* @jpagen.template.list@ (default=db/list.tmpl)
...
fn1. Made by "@flexitpro":http://twitter.com/flexitpro (Visit "flexitpro.com":http://www.flexitpro.com)